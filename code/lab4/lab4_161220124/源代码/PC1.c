...
const unsigned char dest_ip_addr[4] = {192, 168, 2, 2};
...
void Recv()
{
	...
	while(1)
	{
		...
		if(strncmp(iphead->dest_ip, local_ip_addr, 4) == 0 && icmphead->icmp_type == 0x8)
		{
